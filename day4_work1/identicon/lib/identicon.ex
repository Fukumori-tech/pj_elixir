defmodule Identicon do
  ...
  def hash_input(input) do
    hash =
      ...
      %Identicon.Image{hex: hash} #値の更新
  end
  def pick_color(image) do
    %Identicon.Image{hex: [r, g, b | _]} = image #パターンマッチングして、hex:[1,2,3 ...]みたいな
    #この時点でimageはImage構造体でないといけなくなっている、違うとエラーが出る
    %Identicon.Image{image | color: [r, g, b]} #color:[1,2,3]みたいな
